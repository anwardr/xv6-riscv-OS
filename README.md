# CISC-324 Operating System Lab

In this course, we will use the `xv6-riscv` operating system as our core operating system. You'll work directly with its source code to understand operating system concepts in practice.

## Getting Started

Please refer to the [setup guide](setup-xv6-riscv.md) for detailed instructions on installing and running xv6-riscv on your system.
